...
export default function HeroSection() {
  ...
  return (
    <section id="hero" className="min-h-screen flex items-center py-12 md:h-screen md:min-h-0 md:py-0" style={{ backgroundColor: '#253551' }}>
      <div className="max-w-7xl mx-auto px-6 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          <div className="max-w-xl">
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl leading-tight mb-5 md:mb-6 text-white">
              Master IB <span style={{ color: '#C93434' }}>Math</span> &amp; <span style={{ color: '#16AEDE' }}>Geography</span> with Expert Guidance
            </h1>
            <p className="text-base sm:text-lg leading-relaxed mb-4" style={{ color: '#e0e0db' }}>
            ...
            <p className="text-xl sm:text-2xl md:text-3xl font-semibold mb-6" style={{ color: '#e0e0db' }}>
